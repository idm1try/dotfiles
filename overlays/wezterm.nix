{ lib, stdenv, crane-lib, runCommand, src, dbus, egl-wayland, fontconfig
, freetype, libGL, libGLU, libglvnd, libX11, libxcb, libxkbcommon, ncurses
, openssl, perl, pkg-config, python3, wayland, xcbutil, xcbutilimage
, xcbutilkeysyms, xcbutilwm, zlib, CoreGraphics, Cocoa, Foundation, libiconv
, UserNotifications }:
...
let
  ...
  nativeBuildInputs = [ pkg-config python3 ncurses ]
